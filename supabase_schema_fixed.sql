-- =====================================================
-- Agricultural Climate App - Supabase Database Schema (FIXED)
-- =====================================================
...
-- Fixed version without problematic partial indexes
...
-- =====================================================
-- INDEXES FOR PERFORMANCE (FIXED VERSION)
-- =====================================================
...
-- Function to calculate air quality index (IMMUTABLE)
...
-- Function to get pollen risk level (IMMUTABLE)
