...
class OfflineService {
  ...
  static Future<void> _checkConnectivity() async {
    try {
      ...
      LoggingService.info(
        'Connectivity status: ${_isOnline ? 'Online' : 'Offline'}',
      );
    } catch (e) {
  ...
  static Future<void> saveOfflineData(
    ...
    try {
      ...
      LoggingService.error(
        'Failed to save offline data for key: $key',
        error: e,
      );
    }
  }
  ...
  static Future<Map<String, dynamic>?> getOfflineData(String key) async {
    try {
      ...
      LoggingService.error(
        'Failed to get offline data for key: $key',
        error: e,
      );
      return null;
    }
      ...
      for (final action in queue) {
        try {
          ...
          LoggingService.debug(
            'Processing offline action: ${action['action']}',
          );
          ...
          LoggingService.error(
            'Failed to process offline action: ${action['action']}',
            error: e,
          );
        }
      }
